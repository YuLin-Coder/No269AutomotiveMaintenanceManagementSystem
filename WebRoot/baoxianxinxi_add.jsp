 ...
 <form  action="baoxianxinxi_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  ...
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
		<tr><td>车牌号：</td><td><%=Info.getselectsl("chepaihao","chezhuxinxi","chepaihao")%>&nbsp;*<label id='clabelchepaihao' /></td></tr>		<tr><td  width="200">品牌型号：</td><td><input name='pinpaixinghao' type='text' id='pinpaixinghao' style='border:solid 1px #000000; color:#666666' >&nbsp;*<label id='clabelpinpaixinghao' /></td></tr>		<tr><td  width="200">车主姓名：</td><td><input name='chezhuxingming' type='text' id='chezhuxingming' style='border:solid 1px #000000; color:#666666' >&nbsp;*<label id='clabelchezhuxingming' /></td></tr>		<tr><td  width="200">联系电话：</td><td><input name='lianxidianhua' type='text' id='lianxidianhua' style='border:solid 1px #000000; color:#666666' ></td></tr>		<tr><td>保险种类：</td><td><select name='baoxianzhonglei' id='baoxianzhonglei'><option value="强制险">强制险</option><option value="强制险加商业险">强制险加商业险</option></select></td></tr>		<tr><td  width="200">保险公司名称：</td><td><input name='baoxiangongsimingcheng' type='text' id='baoxiangongsimingcheng' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>		<tr><td  width="200">保费金额：</td><td><input name='baofeijine' type='text' id='baofeijine' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelbaofeijine' /></td></tr>		<tr><td width="200">保险到期时间：</td><td><input name='baoxiandaoqishijian' type='text' id='baoxiandaoqishijian' value='' onblur='checkform()' readonly='readonly' onClick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style='width:100px; height:16px; border:solid 1px #000000; color:#666666'/>&nbsp;*<label id='clabelbaoxiandaoqishijian' /></td></tr>		<tr><td  width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>		
    <tr>
      <td>&nbsp;</td>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var chepaihaoobj = document.getElementById("chepaihao"); if(chepaihaoobj.value==""){document.getElementById("clabelchepaihao").innerHTML="&nbsp;&nbsp;<font color=red>请输入车牌号</font>";return false;}else{document.getElementById("clabelchepaihao").innerHTML="  "; } 	var pinpaixinghaoobj = document.getElementById("pinpaixinghao"); if(pinpaixinghaoobj.value==""){document.getElementById("clabelpinpaixinghao").innerHTML="&nbsp;&nbsp;<font color=red>请输入品牌型号</font>";return false;}else{document.getElementById("clabelpinpaixinghao").innerHTML="  "; } 	var chezhuxingmingobj = document.getElementById("chezhuxingming"); if(chezhuxingmingobj.value==""){document.getElementById("clabelchezhuxingming").innerHTML="&nbsp;&nbsp;<font color=red>请输入车主姓名</font>";return false;}else{document.getElementById("clabelchezhuxingming").innerHTML="  "; } 	var baofeijineobj = document.getElementById("baofeijine"); if(baofeijineobj.value==""){document.getElementById("clabelbaofeijine").innerHTML="&nbsp;&nbsp;<font color=red>请输入保费金额</font>";return false;}else{document.getElementById("clabelbaofeijine").innerHTML="  "; } 	var baofeijineobj = document.getElementById("baofeijine"); if(baofeijineobj.value!=""){ if(/^(\+|-)?(0|[1-9]\d*)(\.\d*[1-9])?$/.test(baofeijineobj.value)){document.getElementById("clabelbaofeijine").innerHTML=""; }else{document.getElementById("clabelbaofeijine").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}      var baoxiandaoqishijianobj = document.getElementById("baoxiandaoqishijian"); if(baoxiandaoqishijianobj.value==""){document.getElementById("clabelbaoxiandaoqishijian").innerHTML="&nbsp;&nbsp;<font color=red>请输入保险到期时间</font>";return false;}else{document.getElementById("clabelbaoxiandaoqishijian").innerHTML="  "; } 	
